...
# Update robot name and controller
    ...
    xacro_file = os.path.join(pkg_path,'urdf','robot_5.urdf.xacro')
    ...
    robot_description = Command(['ros2 param get --hide-type /robot_5/robot_state_publisher /robot_5/robot_description'])
