...
# Controller update?
    diff_drive_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["robot_4_diff_cont", "--controller-manager-timeout", "30"],
        namespace=robot_name
    )
...
# Controller update?
    joint_broad_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["robot_4_joint_broad", "--controller-manager-timeout", "30"],
        namespace=robot_name
    )
...
# Controller update?
    joint_piston_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["robot_4_piston_cont", "--controller-manager-timeout", "30"],
        namespace=robot_name
    )
