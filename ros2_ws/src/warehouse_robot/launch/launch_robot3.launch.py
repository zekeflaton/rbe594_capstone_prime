...
# Update robot name and controller
    ...
    xacro_file = os.path.join(pkg_path,'urdf','robot_3.urdf.xacro')
    ...
    robot_description = Command(['ros2 param get --hide-type /robot_3/robot_state_publisher robot_3/robot_description'])
...
# Controller update?
    diff_drive_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["robot_3_diff_cont", "--controller-manager-timeout", "30"],
        namespace=robot_name
    )
...
# Controller update?
    joint_broad_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["robot_3_joint_broad", "--controller-manager-timeout", "30"],
        namespace=robot_name
    )
...
# Controller update?
    joint_piston_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["robot_3_piston_cont", "--controller-manager-timeout", "30"],
        namespace=robot_name
    )
